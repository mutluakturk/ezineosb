<div class="row">
    <div class="col-md-12">
        <!--<h4 class="m-b-lg"><b><?= date('d.m.Y'); ?></b> Tarihli Randevu Listesi
    ...
    <?php //var_dump($this->session->settings->logo); ?>
    <div class="col-md-12">
        <div class="widget p-lg" style="justify-content: center; display: flex">
            <div style="align-items: center">
                <img src="<?php echo base_url('uploads/settings_v/'.$this->session->settings->logo); ?>" style="width: 400px; height: 400px">
            </div>
            <?php if (empty($items)) { ?>
                <!--<div class="alert alert-info text-center">
                    <p>Bugün için Kayıtlı Randevu Bulunmamaktadır Eklemek için <a href="<?php //echo base_url("appointments/new_form") ?>">tıklayınız</a></p>
                </div>-->
            <?php } else { ?>
                ...
                <?php foreach ($items as $item) { ?>
                    <!--<tr>
                            ...
                            <td class="w100">
                                ...
                                <?php } else {
                        if ($this->session->user->user_type == "Yönetim") { ?>

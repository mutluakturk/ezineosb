        ...
        <div class="widget p-lg widget table-responsive">
            <?php if (empty($items)) { ?>
                <div class="alert alert-info text-center">
                    <p>Kayıt Bulunamadı </p> <!--Eklemek için <a href="<?php //echo base_url("members/new_form") ?>">tıklayınız</a>
                    </p> -->
                </div>
            <?php } else { ?>
                ...
                keys: true
                    ...
                    <?php foreach ($items as $item) { ?>
                        <tr>
                            ...
                            <td><?php echo $item->namesurname ?></td>
                            <td><?php echo $item->phone ?></td>

                            <td><?php echo get_readable_date($item->createdAt) ?></td>
                            <td class="text-center">

                                <button data-url="<?php echo base_url("suggestions/delete/$item->id") ?>"

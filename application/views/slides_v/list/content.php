<div class="row">
    <div class="col-md-12">
        <h4 class="m-b-lg">Slayt Listesi
            <a href="<?php echo base_url("slides/new_form") ?>"
            ...
            <?php if (empty($items)) { ?>
                <div class="alert alert-info text-center">
                    <p>Kayıt Bulunamadı Eklemek için <a
                                href="<?php echo base_url("slides/new_form") ?>">tıklayınız</a></p>
                </div>
            <?php } else { ?>
...
<!--                            <td>--><?php ////echo $item->description ?><!--</td>-->
                            <td class="text-center">
                                ...
                                <img width="90" src="<?php echo get_picture($viewFolder, $item->img_url, "1481x715"); ?>"
                            ...
                            <td>
                                <button data-url="<?php echo base_url("slides/delete/$item->id"); ?>"
                                        class="btn btn-danger btn-sm btn-outline remove-btn">
                                    <i class="fa fa-trash"></i></button>
<!--                                <a href="--><?php //echo base_url("slides/update_form/$item->id") ?><!--"-->

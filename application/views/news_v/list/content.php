<div class="row">
    <div class="col-md-12">
        <h4 class="m-b-lg">Haber Listesi
            <a href="<?php echo base_url("news/new_form") ?>" class="btn btn-outline btn-primary btn-xs pull-right "> <i
        ...
        <div class="widget p-lg">
            <?php if (empty($items)) { ?>
                <div class="alert alert-info text-center">
                    <p>Kayıt Bulunamadı Eklemek için <a href="<?php echo base_url("news/new_form") ?>">tıklayınız</a>
                    </p>
                </div>
            <?php } else { ?>
                <table class="table table-hover table-striped table-bordered content-container">
                    ...
                    <?php foreach ($items as $item) { ?>
                        <tr id="ord-<?php echo $item->id ?>">
                            ...
                            <td>
                                <button data-url="<?php echo base_url("news/delete/$item->id"); ?>"
...
<script>var aciklamaOku = function ($icerik) {
        alert($icerik);
    }</script>
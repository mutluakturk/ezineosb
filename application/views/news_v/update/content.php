        ...
        <div class="widget">
            <div class="widget-body">
                <form action="<?php echo base_url("news/update/$item->id"); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <?php } ?>
                    <div class="form-group">
                        <label>Etiketler <small class="text-danger" style="font-weight: bolder">Etiketlerin arasına virgül koyunuz!</small></label>
                        <input name="tags" id="tags" class="form-control" value="<?php echo $item->tags ?>">
                    </div>

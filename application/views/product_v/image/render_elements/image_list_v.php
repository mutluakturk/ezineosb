        ...
        <?php foreach ($item_images as $img) { ?>
            ...
            <tr id="ord-<?php echo $img->id ?>">
                ...
                <td class="w100 text-center"><input
                        data-url="<?php echo base_url("product/imageIsActiveSetter/$img->id") ?>"
                        class="isActive"
                        type="checkbox"
                        data-switchery
                        data-color="#10c469"
                ...
                <td class="w100 text-center"><input
                            data-url="<?php echo base_url("product/isCoverSetter/$img->id/$img->product_id") ?>"
                            class="isCover"
                            type="checkbox"
                            data-switchery
                            data-color="#f9c851"
                ...
                <td class="w100 text-center">
                    <button data-url="<?php echo base_url("Product/imageDelete/$img->id/$img->product_id"); ?>"

    ...
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-body">
                <form action="<?php echo base_url("Announcenment/update/$item->id"); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <?php if (isset($form_error)){ ?>
                        <div class="form-group img_upload_container" style="display: <?php echo ($news_type == "image")? "block" : "none"; ?>">
                    ...
                    <?php } else { ?>
                        <div class="row">
                            ...
                            <div class="col-md-9 form-group img_upload_container" style="display: <?php echo ($item->news_type == "image") ? "block" : "none"; ?>">
                                <label>Görsel Seçiniz</label>
                                <input type="file" name="img_url" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group video_url_container" style="display: <?php echo ($item->news_type == "video") ? "block" : "none"; ?>">
                            <label>Video URL</label>
                            <input class="form-control" name="video_url" placeholder="Video URL" value="<?php echo $item->video_url ?>">
                        </div>
                    <?php } ?>
                    <button type="submit" class="btn btn-primary btn-md btn-outline">Güncelle</button>
                    <a href="<?php echo base_url("Announcenment"); ?>" class="btn btn-md btn-danger btn-outline">İptal</a>
                </form>
            </div><!-- .widget-body -->
        </div>
    </div>

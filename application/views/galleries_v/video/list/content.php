<div class="row">
    <div class="col-md-12">
        <h4 class="m-b-lg"><?php echo "<b>$gallery->title</b> galerisine ait videolar"; ?>
    ...
    <div class="col-md-12">
        <div class="widget p-lg">
            ...
            <div class="alert alert-info text-center">
                <p>Kayıt Bulunamadı Eklemek için <a href="<?php echo base_url("galleries/new_gallery_video_form/$gallery->id") ?>">tıklayınız</a></p>
            </div>
            <?php } else { ?>
                    ...
                    <tr id="ord-<?php echo $item->id ?>">
                        ...
                        <td>
                            <iframe
                                ...
                                src="<?= str_replace("watch?v=", "embed/", $item->url) . '?controls=0'; ?>"
                                frameborder="0"
                                gesture="media"
                        ...
                        <td>
                            ...
                            <a href="<?php echo base_url("galleries/update_gallery_video_form/$item->id") ?>" class="btn btn-info btn-sm btn-outline"><i class="fa fa-pencil"></i></a>
                        </td>
                    </tr>
                <?php } ?>
                </tbody>

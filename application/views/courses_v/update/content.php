                ...
                <form action="<?php echo base_url("courses/update/$item->id"); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="hidden" value="<?php echo $item->event_date; ?>" name="event_date" data-plugin="datetimepicker" data-options="{ inline: true, viewMode: 'days', format : 'YYYY-MM-DD HH:mm:ss' }" />
                        </div>
                        ...
                        <div class="col-md-7 form-group img_upload_container">

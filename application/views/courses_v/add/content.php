                ...
                <form action="<?php echo base_url("courses/save"); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <input type="hidden" name="event_date" data-plugin="datetimepicker" data-options="{ inline: true, viewMode: 'days', format : 'YYYY-MM-DD HH:mm:ss' }" />
                        </div>

                        <div class="form-group img_upload_container col-md-8">

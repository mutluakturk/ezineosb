    ...
    <div class="col-md-12">
        <div class="widget p-lg">
            ...
            <div class="alert alert-info text-center">
                <p>Kayıt Bulunamadı Eklemek için <a href="<?php echo base_url("courses/new_form") ?>">tıklayınız</a></p>
            </div>
            <?php } else { ?>
            <table class="table table-hover table-striped table-bordered content-container">
                ...
                <?php foreach ($items as $item) {?>
                    <tr id="ord-<?php echo $item->id ?>">
                        ...
                        <td class="text-center w100"><?php echo get_readable_date($item->event_date); ?></td>
                        ...
                        <td class="w100">
                            <button data-url="<?php echo base_url("courses/delete/$item->id"); ?>"
                                    class="btn btn-danger btn-sm btn-outline remove-btn">
                                <i class="fa fa-trash"></i></button>
                            <a href="<?php echo base_url("courses/update_form/$item->id") ?>" class="btn btn-info btn-sm btn-outline"><i class="fa fa-pencil"></i></a>
                        </td>
                    </tr>
                <?php } ?>
                </tbody>

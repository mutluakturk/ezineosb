...
class Suggestions extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->viewFolder = "suggestions_v";
        $this->load->model("suggestions_model", "news");
    ...
    public function suggestionAjaxSave()
    {
        $insert = $this->news->add(
            array(
                "title" => $this->input->post("konu"),
                "namesurname" => $this->input->post("adSoyad"),

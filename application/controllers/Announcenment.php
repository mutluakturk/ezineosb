...
class Announcenment extends CI_Controller
{
    public $viewFolder = "";
    ...
    {
        parent::__construct();
        $this->viewFolder = "announcenments_v";
    ...
    public function index()
    {
        ...
        $items = $this->news->get_all(array("master_type" => "announcenment"), "id DESC");
    ...
    public function save()
    {
        ...
        if ($news_type == "image") {
            if ($_FILES["img_url"]["name"] == "") {
                ...
                redirect(base_url("Announcenment/new_form"));
            }
        ...
        if ($validate) {
            ...
            redirect(base_url("Announcenment"));
            ...
            if ($news_type == "image") {
                ...
                if ($_FILES["img_url"]["name"] !== "") {
                    ...
                    if ($upload) {
                        ...
                        $alert = array(
                            "title" => "İşlem Başarısız",
                            "text" => "Görsel yükleme esnasında problem oluştu! ".$error['error'],
                            "type" => "error"
                        );
                        ...
                        redirect(base_url("Announcenment/update_form/$id"));
                        die();
                    }
                } else {
                    $data = array(
